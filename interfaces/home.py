...
def appHome():
    ...
    img1 = customtkinter.CTkImage(Image.open("images/pattern.png"), size=(app_home.winfo_screenwidth(), app_home.winfo_screenheight()))
    userImage = Image.open("images/user.png")
    notaImage = Image.open("images/notas.png")
    materiaImage = Image.open("images/calendar.png")

    background = customtkinter.CTkLabel(master=app_home, image=img1, text="")
    background.pack()
