...
def show_invalid_nota():
    msgbox = ctk.CTkMessagebox(message="Insira uma nota válida(00.00 - 10.00)",
                            width=300,
                            height=150,
...
def show_nonexisting_email_message():
    msgbox = ctk.CTkMessagebox(message="Este E-mail não consta.",
                               width=300,
                               height=150,
